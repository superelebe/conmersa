      ...
      .done(function( data ) {
        ...
        //console.log(data['principal_servicio']['file_name']);
         ...
         if (idioma == 'EN') {
          ...
          imagen_principal_mkt=data['principal_servicio_ingles']['file_name'];
        
        }
        else{
          
          imagen_principal_mkt=data['principal_servicio']['file_name']

        };

        $('#milky_bottle').attr('src', 'admin/paginas/secciones/'+imagen_principal_mkt);
        ...
        $.each(servicios_mkt,function(key, value){
          ...
          //console.log(value);
            ...
            el_actual.find('.template_bnt').attr('href',value.url);
   ...
   //  });
    ...
    $("#accordion").on('show.bs.collapse', function(){
        ...
        if (jQuery.browser.mobile) {
          ...
          console.log(300);
          $(window).scrollTop($('#accordion').offset().top-0);
        };
