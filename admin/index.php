...
$destino = array(
  ...
  'seccion_inicio' => 'paginas/secciones/inicio',
   ...
   'vacantes' => 'paginas/bolsatrabajo/vacantes',
   'tipos_vacante' => 'paginas/bolsatrabajo/tipos_vacantes',
   'solicitante' => 'paginas/bolsatrabajo/solicitante'
        ...
        <nav class="navbar mainmenu">
            ...
            <div class="collapse navbar-collapse pull-right" id="navbar-collapse">
                ...
                <li class="">
                    ...
                    <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown">Vacantes</a>
                      <ul class="dropdown-menu">
                        <li><a href="index.php?seccion=vacantes" class="">vacantes</a></li>
                        <li><a href="index.php?seccion=tipos_vacante" class="">Tipo de vacante</a></li>
                        <li><a href="index.php?seccion=solicitante" class="">Solicitante</a></li>
                      </ul>
                    </li>
...
<script type="text/javascript" src="paginas/bolsatrabajo/js/control.js"></script>    
