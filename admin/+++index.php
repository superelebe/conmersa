...
$destino = array(
  ...
  // 'proyecto' => 'paginas/proyecto/index',
  // 'clase_proyecto' => 'paginas/proyecto/clase_producto',
  // 'categoria_proyecto' => 'paginas/proyecto/categoria_producto',

  'galeria' => 'paginas/galeria/index',
  'tipos_galeria' => 'paginas/galeria/tipos_galeria',

  //   'galeria_videos' => 'paginas/galeria_videos/index',
  // 'tipos_galeria_videos' => 'paginas/galeria_videos/tipos_galeria'
...
?>
    ...
    <div class="logo_gto col-sm-2 col-sm-offset-5"><img src="img/logo.png" alt="FASHION GTO"></div>
               ...
               <!--      
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="index.php?seccion=galeria_videos" class="">VIDEOS</a></li>
                        <li><a href="index.php?seccion=tipos_galeria_videos" class="">Tipo de VIDEOS</a></li>
                      </ul>
                    </li>
 -->
...
<?
 ...
 //   case 'proyecto':
 //        $seccion_actual="Proyectos Rescate Histórico";
 //       $_SESSION[$sesion_name][seccion_previa]="proyecto";
 //      break;

 //      case 'clase_proyecto':
 //        $seccion_actual="Clase del proyecto";
 //       $_SESSION[$sesion_name][seccion_previa]="proyecto";
 //      break;

 // case 'categoria_proyecto':
 //        $seccion_actual="categoria del proyecto";
 //       $_SESSION[$sesion_name][seccion_previa]="proyecto";
 //      break;
